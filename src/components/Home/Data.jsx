...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <h1 className="home__title">Surya Kalikiripalli
        ...
        <p className="home__description">I'm a creative developer based in India. <br />I am very passionate and efficient to my work.</p>
